                ...
                <form action="<?php echo site_url('blog/search');?>" method="get">
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        <input type="text" name="keyword" class="form-control" placeholder='Cari Diskusi Dosini'
...
<section class="blog_area section-padding">
      <button class="button rounded-0 primary-bg text-white w-100 btn_1 boxed-btn"
                                    type="submit">POSTING DISKUSI BARU</button>
                            </form>
        <div class="container">
            <div class="row">
                        ...
                        <article class="blog_item">
                            ...
                            <div class="blog_details">
                                ...
                                <ul class="blog-info-link">
                                    <li><a href="#"><i class="fa fa-tag"></i> <?php echo $row->tulisan_kategori_nama;?></a></li>
                                    <li><a href="#"><i class="fa fa-user"></i> <?php echo $row->tulisan_author;?></a></li>
                                </ul>
                            </div>
                        </article>
                        <?php endforeach;?>
