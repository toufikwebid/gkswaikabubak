...
<head>
  ...
  ?>
    ...
    <meta name="description" content="HAFA DIGITAL DEVELOPMENT">
    <meta name="author" content="HAFA DIGITAL">
    ...
    <link href="<?php echo base_url(''); ?>admin/css/styleadmin.css" rel="stylesheet">
